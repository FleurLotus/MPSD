namespace Common.UnitTests.ViewModel
{
    ...
    public class NotifyPropertyChangedTest
    {
        ...
        public void TestWithNoLink()
        {
            ...
            Assert.IsTrue(_notified[^1] == "Property1", "not the expected notification after Property1 set");
            _vm.Property4 = "a";
            Assert.IsTrue(_notified.Count == 2, "not the expected number of notification after property4 set");
            Assert.IsTrue(_notified[^1] == "Property4", "not the expected notification after Property4 set");
            _vm.Property7 = "a";
            Assert.IsTrue(_notified.Count == 3, "not the expected number of notification after Property7 set");
            Assert.IsTrue(_notified[^1] == "Property7", "not the expected notification after Property7 set");
        }
        [Test]
        public void TestWithLink()
        {
            ...
            Assert.IsTrue(_notified[^3] == "Property1", "not the expected notification after Property1 set");
            Assert.IsTrue(_notified[^2] == "Property2", "not the expected notification after Property1 set");
            Assert.IsTrue(_notified[^1] == "Property3", "not the expected notification after Property1 set");
            _vm.Property4 = "a";
            Assert.IsTrue(_notified.Count == 6, "not the expected number of notification after Property4 set");
            Assert.IsTrue(_notified[^3] == "Property4", "not the expected notification after Property4 set");
            Assert.IsTrue(_notified[^2] == "Property5", "not the expected notification after Property4 set");
            Assert.IsTrue(_notified[^1] == "Property6", "not the expected notification after Property4 set");
            _vm.Property7 = "a";
            Assert.IsTrue(_notified.Count == 8, "not the expected number of notification after Property7 set");
            Assert.IsTrue(_notified[^2] == "Property7", "not the expected notification after Property7 set");
            Assert.IsTrue(_notified[^1] == "Property8", "not the expected notification after Property7 set");
        }
