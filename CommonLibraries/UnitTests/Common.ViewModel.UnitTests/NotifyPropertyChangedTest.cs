namespace Common.ViewModel.UnitTests
{
    ...
    public class NotifyPropertyChangedTest
    {
        ...
        {
            Assert.That(_notified.Count, Is.EqualTo(0), "Not empty collection");
            _vm.Property1 = "a";
            Assert.That(_notified.Count, Is.EqualTo(1), "not the expected number of notification after Property1 set");
            Assert.That(_notified[^1], Is.EqualTo("Property1"), "not the expected notification after Property1 set");
            _vm.Property4 = "a";
            Assert.That(_notified.Count, Is.EqualTo(2), "not the expected number of notification after property4 set");
            Assert.That(_notified[^1], Is.EqualTo("Property4"), "not the expected notification after Property4 set");
            _vm.Property7 = "a";
        ...
        public void TestWithLink()
        {
            ...
            Assert.That(_notified.Count, Is.EqualTo(0), "Not empty collection");
            _vm.Property1 = "a";
            Assert.That(_notified.Count, Is.EqualTo(3), "not the expected number of notification after Property1 set");
            Assert.That(_notified[^3], Is.EqualTo("Property1"), "not the expected notification after Property1 set");
            Assert.That(_notified[^2], Is.EqualTo("Property2"), "not the expected notification after Property1 set");
            Assert.That(_notified[^1], Is.EqualTo("Property3"), "not the expected notification after Property1 set");
            _vm.Property4 = "a";
            Assert.That(_notified.Count, Is.EqualTo(6), "not the expected number of notification after Property4 set");
            Assert.That(_notified[^3], Is.EqualTo("Property4"), "not the expected notification after Property4 set");
            Assert.That(_notified[^2], Is.EqualTo("Property5"), "not the expected notification after Property4 set");
            Assert.That(_notified[^1], Is.EqualTo("Property6"), "not the expected notification after Property4 set");
            _vm.Property7 = "a";
