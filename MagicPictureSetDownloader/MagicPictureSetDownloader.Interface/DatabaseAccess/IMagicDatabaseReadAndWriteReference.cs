namespace MagicPictureSetDownloader.Interface
{
    ...
    public interface IMagicDatabaseReadAndWriteReference : IMagicDatabaseReadOnly
    {
        ...
        void CreateNewEdition(string sourceName, string name, bool hasFoil, string code, int? idBlock, int? blockPosition, int? cardNumber, DateTime? releaseDate, byte[] icon);
